...
class Form extends Component {
    ...
    */
    constructor (props) {
        ...
        this.state = {
            ...
            password: '',
            cpassword :'',
            formErrors: { fname:'', lname : '',email: '', password: '', cpassword :''},
            fnameValid: false,
            lnameValid: false,
            emailValid: false,
            passwordValid: false,
    ...
    */
    validateField(fieldName, value) {
        ...
        let fnameValid = this.state.emailValid;
        let lnameValid = this.state.emailValid;
    ...
    */
    validateForm() {
        this.setState({formValid: this.state.fnameValid && this.state.lnameValid && this.state.emailValid && this.state.passwordValid && this.state.cpasswordValid});
                                ...
                                <fieldset>
                                    ...
                                    <div className={`form-group ${this.errorClass(this.state.formErrors.email)}`}>
                                        <label htmlFor="email" className="k-form-field">
                                            ...
                                            <input type="email" className="k-textbox"   required name="email" placeholder="Email" value={this.state.email} onChange={this.handleUserInput} />
                                        </label>
                                    </div>
                                    <div className={`form-group ${this.errorClass(this.state.formErrors.password)}`}>
                                        <label className="k-form-field" htmlFor="password">
                                            <span>Password <span className="k-required">*</span></span>
                                            <input className="k-textbox"  required name="password" placeholder="Password" value={this.state.password} onChange={this.handleUserInput}  />
                                        </label>
                                    </div>
                                    <div className={`form-group ${this.errorClass(this.state.formErrors.cpassword)}`}>
                                        <label className="k-form-field" >
                                            ...
                                            <input className="k-textbox" required placeholder="Confirm Password" name="cpassword"  value={this.state.cpassword} onChange={this.handleUserInput}/>
                                        </label>
                                    </div>
                                    <div>
